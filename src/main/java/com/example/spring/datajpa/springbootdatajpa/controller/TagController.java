...
import com.example.spring.datajpa.springbootdatajpa.repository.TagRepository;
...
public class TagController {
    ...
    public ResponseEntity<List<Tutorial>> getTutorialsByTagId(@PathVariable("tagId") long tagId) {
